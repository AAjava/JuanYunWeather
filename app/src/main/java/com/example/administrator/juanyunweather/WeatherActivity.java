...
import com.example.administrator.juanyunweather.gson.Forecast;
import com.example.administrator.juanyunweather.gson.Weather;
import com.example.administrator.juanyunweather.service.AutoUpdateService;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    private void showWeatherInfo(Weather weather) {
        ...
        for (Forecast forecast : weather.forecastList) {
            ...
            View view = layoutInflater.inflate(R.layout.forecast_item, forecastLayout, false);
        ...
        String comfot = "舒适度：" + weather.suggestion.comfortable.info;
